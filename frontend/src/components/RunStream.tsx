...
export function RunStream({ selectedRun, isLoading, onRerun }: RunStreamProps) {
  // Removed streamEndRef as we now show latest at top
  ...
  return (
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
          ...
          {/* OUTPUT TERMINAL (Still at top contextually, or move below logs? Standard is usually separate. Keep at top.) */}
          ...
          {/* Changed timeline to dashed and simpler since order is reversed */}
